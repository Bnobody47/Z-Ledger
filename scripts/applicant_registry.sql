-- Applicant Registry schema (optional — used by LLM agents for company/financial data)
-- Run as part of setup_all.sql or separately after main schema
...
GRANT ALL ON ALL SEQUENCES IN SCHEMA applicant_registry TO bnobody;
